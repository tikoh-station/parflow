...
#ifndef _CARTESIAN_TRANSFORM_HEADER
#define _CARTESIAN_TRANSFORM_HEADER
...
typedef PFModule *(*CartesianTransformNewPublicXtraInvoke)(CoordinateTransformMethods *coordinate_transform_methods);
...
#endif // _CARTESIAN_TRANSFORM_HEADER